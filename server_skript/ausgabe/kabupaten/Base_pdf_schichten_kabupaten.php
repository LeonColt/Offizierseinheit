 ...
 * Time: 19:19
 */
require_once standart_system_pfad.'server_skript/ausgabe/kabupaten/pdf_daten_bergmann_kabupaten.php';
require_once standart_system_pfad.'server_skript/library/PDF/fpdf.php';
class Base_pdf_schichten_kabupaten extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0,7,'PRIMER DAN SEKUNDER',0,1,'C');
        $this->Cell(0,7,('PROPINSI '.filter_input(INPUT_GET, ausgabe_parameter_provinz_zeichenfolge)),0,1,'C');
        $this->Cell(0,7,'BERDASARKAN KABUPATEN/KOTA',0,1,'C');
        $this->Cell(0,7,'POSISI',0,1,'C');
        $this->daten = new pdf_daten_bergmann_kabupaten();
