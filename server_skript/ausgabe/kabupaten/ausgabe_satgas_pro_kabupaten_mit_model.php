 ...
 * Time: 10:54
 */
class ausgabe_satgas_pro_kabupaten_mit_model extends Bergmann
{
...
WHERE tanggal = ? AND id_model = ? AND id_propinsi = ?
...
'.kspo_daten_bank_name.'.tbllistbentukkoperasi.IdBentukKoperasi) AS ausgabe_provinz
        ...
        $this->parameter = array(implode('-', $temp), filter_input(INPUT_GET, ausgabe_parameter_model), filter_input(INPUT_GET, ausgabe_parameter_provinz));
    }
