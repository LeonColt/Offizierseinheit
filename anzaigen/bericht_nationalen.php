...
require_once standart_system_pfad.'anhanger/anhanger_ausgabe_nationalen.php';
require_once standart_system_pfad.'anhanger/anhanger_gemeinsame.php';
require_once standart_system_pfad.'server_skript/ausgabe/nationalen/wichstigsten_ausgabe_nationalen.php';
require_once standart_system_pfad.'anzaigen/Base_anzaigen.php';
class bericht_nationalen extends Base_anzaigen
{
    ...
    protected function client_skript()
    {
        ...
        $this->satz_client_skript(client_skript_ausgabe_nationalen, client_skript_pdf, client_skript_ist_sitzung_korriegieren);
    }

    protected function korper()
    {
        // TODO: Implement korper() method.
        require_once standart_system_pfad.'anzaigen/korper/bericht_nationalen_korper.php';
    }
}